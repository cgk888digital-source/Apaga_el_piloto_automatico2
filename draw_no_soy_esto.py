...
def create_circular_diagram():
    ...
    for i, label in enumerate(labels):
        ...
        draw.multiline_text((bx - text_w/2, by - text_h/2 - 4), label, fill=text_color, font=font_bold, align="center")
        
    center_label = "Meditación\nYo No Soy\nEsto"
    ...
    out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "imagenes", "meditacion_no_soy_esto.png")
