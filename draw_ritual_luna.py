...
def create_circular_diagram():
    ...
    colors = [
        "#1F3160", # Night blue
        "#4A235A", # Deep purple
        "#5D6D7E", # Slate moonlight
        "#117864", # Deep teal moonlight
    ]
    ...
    out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "imagenes", "ritual_luna.png")
