...
def create_circular_diagram():
    ...
    for i, label in enumerate(labels):
        ...
        # Use darker text for yellow to maximize contrast
        if i == 2:
            text_color = (0, 0, 0)
            
        draw.multiline_text((text_x, text_y), label, fill=text_color, font=font_bold, align="center")
    ...
    out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "imagenes", "practica_90_seg.png")
