...
def create_circular_diagram():
    ...
    for i, label in enumerate(labels):
        ...
        # For Yellow, use dark text for visibility
        if i == 4:
            text_color = (0, 0, 0)
    ...
    out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "imagenes", "ciclo_sagrado.png")
